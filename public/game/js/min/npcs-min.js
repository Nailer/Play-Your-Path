var npc = {
  fish: {
    ...
    move: function (a) {
      var b = $("#fish");
      a ? b.spToggle().fps(8).spState(2) : b.spState(2);
      var a = function (b) {
        b.animate({ left: 242, top: -236 }, 5e3, "linear", function () {
          b.spState(3);
  ...
  furnace: {
    ...
    is_eating: function () {
      ...
      b.animate({ opacity: 0.5 }, 375).animate({ opacity: 0 }, 375);
      Modernizr.csstransitions
        ? a
            .transition({ top: "-=80" }, 250)
            .transition({ top: "+=80" }, 100, function () {
    ...
    is_strong: function () {
      var a = npc.furnace.furnace(),
        b = npc.furnace.body(),
        c = npc.furnace.eyes(),
        d = npc.furnace.mouth(),
        e = npc.furnace.fire();
      a.text_cloud("YEAH!", 2e3);
      d.attr("style", "");
      if (!Modernizr.csstransitions) {
        b.css({ rotate: "rotate(0deg)" });
        b.animate({ top: 15 }, 500, function () {
          sound_screech.play();
        })
          .animate({ top: -3 }, 100)
          .delay(300)
        ...
        b.transition({ top: 15, rotate: 0 }, 500, function () {
          sound_screech.play();
        })
      ...
      d.animate({ top: 435 }, 700)
        ...
        .animate({ top: 515 }, 100, function () {
          ...
          a.text_cloud("Thank you man!", 2e3);
          setTimeout(function () {
            a.text_cloud("Check your room! Things have changed!", 2e3);
          }, 3e3);
          npc.furnace.burn();
          npc.furnace.random_moves();
          var b = $.jStorage.get("played");
          b.push("scene_furnace");
          $.jStorage.set("played", b);
    ...
    is_weak: function () {
      ...
      scene.no_click(!0);
      $.inArray("twig", used) === -1
        ? a.text_cloud("I'm weak...", 2e3)
        : $.inArray("note", used) === -1
        ? a.text_cloud("Help me please...", 2e3)
        : $.inArray("coal", used) === -1 &&
          a.text_cloud("Still hungry...", 2e3);
      e.animate({ opacity: 0.5 }, 1700).animate(
        { opacity: 0 },
        300,
        function () {
          scene.no_click(!1);
      ...
      sound_screech.play();
      if (!Modernizr.csstransitions) {
        b.animate({ top: 5, rotate: 1 }, 1700)
          .animate({ top: 10, rotate: -0.5 }, 100)
          .animate({ top: 7 }, 50)
          .animate({ top: 10 }, 50)
          .animate({ top: 8 }, 50)
          .animate({ top: 10 }, 50);
        d.animate({ top: "-=10" }, 1700)
        ...
        b.transition({ top: 5, rotate: 1 }, 1700)
          .transition({ top: 10, rotate: -0.5 }, 100)
          .transition({ top: 7 }, 50)
          .transition({ top: 10 }, 50)
          .transition({ top: 8 }, 50)
          .transition({ top: 10 }, 50);
        d.transition({ top: "-=10" }, 1700)
